...
namespace NsisoLauncher.Views.Windows
{
    ...
    public partial class ErrorWindow : MetroWindow
    {
        ...
        {
            Process.Start("mailto:siso@nsiso.com");
        }
        ...
        {
            Process.Start(
                "http://shang.qq.com/wpa/qunwpa?idkey=3b39ff435aeca097dbe8bcef6f32d26367bdb630357570693b5315e6c13f7c9f");
        }

        //作者github点击后
        private void Hyperlink_Click_2(object sender, RoutedEventArgs e)
        {
            Process.Start("https://github.com/Nsiso");
        }
        ...
        private async void RebootButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                await App.NsisoAPIHandler.PostLogAsync(LogLevel.FATAL, report);
            }
            catch (Exception ex)
            {
        ...
        private string GetEnvironmentInfo()
        {
            ...
            builder.Append("\r\n内存信息: 总大小:" + SystemTools.GetTotalMemory() + "MB/可用大小:" + SystemTools.GetRunmemory() +
                           "MB");
        ...
        {
            return Task.Factory.StartNew(() => { return GetEnvironmentInfo(); });
        }
        ...
        private string GetReport()
        {
            ...
            strBuilder.AppendFormat("Date:{0}    Launcher Version:{1}", DateTime.Now,
                Application.ResourceAssembly.GetName().Version).AppendLine();
