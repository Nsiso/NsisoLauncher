...
namespace NsisoLauncherCore.Util.Installer.Forge.Json
{
    public class Install
    {
        ...
        /// <summary>
        ///     Extra libraries needed by processors, that may differ from the installer version's library list. Uses the same
        ///     format as Mojang for simplicities sake.
        /// </summary>
        ...
        {
            /// <summary>
            ///     The executable jar to run, The installer will run it in-process, but external tools can run it using java -jar
            ///     {file}, so MANFEST Main-Class entry must be valid.
            /// </summary>
            [JsonProperty("jar")]
            public Artifact Jar { get; set; }

            /// <summary>
            ///     Dependency list of files needed for this jar to run. Aything listed here SHOULD be listed in {@see
            ///     Install#libraries} so the installer knows to download it.
            /// </summary>
