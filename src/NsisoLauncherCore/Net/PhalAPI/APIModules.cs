...
namespace NsisoLauncherCore.Net.PhalAPI
{
    ...
    {
        [JsonProperty("ret")] public int Ret { get; set; }
    ...
    {
        [JsonProperty("list")] public List<NsisoLauncherVersionResponse> List { get; set; }

        [JsonProperty("total")] public int Total { get; set; }

        [JsonProperty("err_msg")] public string ErrorMessage { get; set; }

        [JsonProperty("err_code")] public int ErrorCode { get; set; }
    }
