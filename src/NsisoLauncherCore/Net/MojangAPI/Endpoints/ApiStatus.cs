...
namespace NsisoLauncherCore.Net.MojangApi.Endpoints
{
    ...
    public class ApiStatus : IEndpoint<ApiStatusResponse>
    {
        ...
        public ApiStatus()
        {
            Address = new Uri("https://status.mojang.com/check");
        }
        ...
        public override async Task<ApiStatusResponse> PerformRequestAsync()
        {
            ...
            {
                var jstatuses = JArray.Parse(Response.RawMessage);
                ...
                return new ApiStatusResponse(Response)
                {
                    ...
                    MojangAccounts =
                        ApiStatusResponse.Parse(statuses.TryGetValue("account.mojang.com", out v) ? v : null),
                    MojangAutenticationServers =
                        ApiStatusResponse.Parse(statuses.TryGetValue("authserver.mojang.com", out v) ? v : null),
                    MojangSessionsServer =
                        ApiStatusResponse.Parse(statuses.TryGetValue("sessionserver.mojang.com", out v) ? v : null),
                    MojangApi = ApiStatusResponse.Parse(statuses.TryGetValue("api.mojang.com", out v) ? v : null),
                    Textures =
                        ApiStatusResponse.Parse(statuses.TryGetValue("textures.minecraft.net", out v) ? v : null),
                    ...
                    MojangAuthenticationService =
                        ApiStatusResponse.Parse(statuses.TryGetValue("auth.mojang.com", out v) ? v : null),
